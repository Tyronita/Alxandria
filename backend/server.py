        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    # Valid Kaggle dataset format: username/dataset-name\n",
                    ...
                    "else:\n",
                    "    print('No valid Kaggle dataset specified.')\n",
                    "    print('Manually load your dataset:')\n",
                    "    print('  df = pd.read_csv(\"path/to/your/data.csv\")')\n",
                    "\n",
                    "# Example: Load CSV data if exists\n",
                    ...
                    "    print(df.info())\n",
                    "else:\n",
                    "    print('\\nNo CSV files found. Adjust the loading code for your data format.')"
                ]
            },
            {
                "cell_type": "markdown",
